    ...
    <main>
      ...
      <section id="proximas" className="section">
        <div className="section-title">
          <h3>Nossos Pacotes de Viagem (Vendas)</h3>
          <div></div>
        </div>
        ...
        <div style={{ 
          ...
          border: '1px solid rgba(212, 175, 55, 0.4)', maxWidth: '1000px', boxShadow: '0 10px 30px rgba(212,175,55,0.05)'
           ...
           <div style={{ flex: 1, minWidth: '280px', display: 'flex', alignItems: 'center', gap: '20px' }}>
              <div style={{fontSize: '2.5rem', background: '#fff', padding: '15px', borderRadius: '50%', boxShadow: '0 4px 10px rgba(0,0,0,0.05)'}}>📍</div>
              <div>
                <strong style={{ display: 'block', color: '#0B192C', fontSize: '1.15rem', marginBottom: '5px' }}>Embarques Flexíveis</strong>
                <span style={{ color: '#444', fontSize: '1rem', lineHeight: '1.4' }}>A nossa partida <b>sempre tem vários locais de embarque</b>, desenhados para que você suba no ponto mais próximo de sua casa com toda a comodidade.</span>
              </div>
           </div>
           ...
           <div style={{ flex: 1, minWidth: '280px', display: 'flex', alignItems: 'center', gap: '20px' }}>
              <div style={{fontSize: '2.5rem', background: '#fff', padding: '15px', borderRadius: '50%', boxShadow: '0 4px 10px rgba(0,0,0,0.05)'}}>💳</div>
              <div>
                <strong style={{ display: 'block', color: '#0B192C', fontSize: '1.15rem', marginBottom: '5px' }}>Pagamento Totalmente Facilitado</strong>
                <span style={{ color: '#444', fontSize: '1rem', lineHeight: '1.4' }}>Nós garantimos a sua viagem com condições excelentes. Aceitamos pagamentos à vista via <b>PIX</b> ou no seu <b>Cartão de Crédito</b>, facilitamos seu pagamento!</span>
              </div>
           </div>
        </div>
      ...
      <section id="fotos" className="section" style={{ background: '#F8FAF9' }}>
        ...
        <p style={{textAlign: 'center', maxWidth: '800px', margin: '0 auto 4rem', fontSize: '1.1rem', color: '#555', fontFamily: 'Inter'}}>
          Um pouco da nossa história. Veja as fotos dos nossos queridos passageiros, a animação nas viagens e também nossa equipe em encontros inesquecíveis com os Padres nos Santuários.
        </p>
        <Gallery />
      </section>
      ...
      <section className="section" style={{ background: '#fff', borderTop: '1px solid rgba(0,0,0,0.05)' }}>
         <div style={{ maxWidth: '800px', margin: 'auto', textAlign: 'center', padding: '2rem 0' }}>
            <span style={{ fontSize: '4rem', color: '#D4AF37', fontFamily: 'Cinzel', lineHeight: 0, opacity: 0.3, display: 'block', marginBottom: '20px' }}>"</span>
            <p style={{ fontFamily: 'Cinzel', fontSize: '1.9rem', color: '#0B192C', lineHeight: '1.6', margin: '0 0 3rem 0', fontStyle: 'italic' }}>
               Acreditamos que cada viagem é sagrada. Há 28 anos, nossa maior honra é conduzir sua família com extremo conforto e segurança inabalável ao encontro da sua fé.
            </p>
      ...
      <section id="contato" className="contact-section">
        <div className="contact-grid">
          <div className="contact-info">
            <h3 style={{ fontSize: '2.5rem' }}>Fale com a <br/><span style={{ color: 'white', fontFamily: 'Cinzel', display: 'block', marginTop: '10px', fontSize: '2.8rem' }}>Agência Santa Edwirges</span></h3>
            <p>Garanta o seu assento! Nossa equipe está altamente preparada para auxiliar você em todo o processo de reserva. Atendimento humanizado e rápido.</p>
          ...
          <div style={{ background: 'rgba(255,255,255,0.05)', padding: '4rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.1)' }}>
             <h4 style={{fontFamily: 'Cinzel', fontSize: '1.8rem', color: '#D4AF37', marginBottom: '2rem'}}>O que as pessoas dizem:</h4>
             <p style={{fontStyle: 'italic', fontSize:'1.1rem', color: 'white', opacity: 0.8, marginBottom: '1.5rem'}}>
               "A Agência Santa Edwirges me levou para Aparecida do Norte. Foi a viagem com mais paz e extremo conforto que já tive na vida. O ônibus e os hotéis são sempre 5 estrelas!"
             </p>
      ...
      <footer className="footer">
         Agência de Turismo Santa Edwirges © {new Date().getFullYear()} - Tradição e Fé. Todos os direitos reservados.
      </footer>
